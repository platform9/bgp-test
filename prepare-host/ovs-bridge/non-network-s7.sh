...
ip addr add 131.153.225.181/28 dev br-pf9
ovs-vsctl set bridge br-pf9 other_config:hwaddr=7c:c2:55:44:76:a0
ip link set dev br-pf9 up
ip addr del 131.153.225.181/28 dev bond0.600
